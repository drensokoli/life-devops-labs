#!/usr/bin/env bash
# verify.sh — Lab 09 completion check
#
# Run this script from the 09-compose-homework directory while your
# docker compose stack is running.
#
# Usage:
#   ./verify.sh
#
# The script checks every service, records pass/fail for each step,
# and writes lab-09-receipt.md. Re-run as many times as you like.
...
_container_name() {
  # Returns the first container name matching a service name inside the
  # life-shortener compose project.
  local service="$1"
